...
export type PublicTimelineEvent = { id: string; kind: TimelineEventKind; title: string; detail: string | null; actor_name: string | null; result_summary: string | null; success: boolean | null; knowledge_changes: KnowledgeChange[]; occurred_at: string | null; duration_ms?: number | null };
...
export type PublicTaskSummary = { id: string; sequence: number; goal: string; status: string; execution_phase: ExecutionPhase; created_at: string; completed_at: string | null };
export type PlayerGameState = { game: GameSummary; visible_nodes: Array<{ key: string; name: string; accessible: boolean }>; known_facts: Array<{ node_key: string; fact_key: string; name: string; value: string | number | boolean }>; resources: Array<{ key: string; name: string; value: number; reserved_value: number; scope_node_key?: string | null }>; actors: Array<{ key: string; name: string; role_name: string; current_node_name: string }>; current_task: PublicTask | null; task_history: PublicTaskSummary[]; pending_approval_id: string | null };
