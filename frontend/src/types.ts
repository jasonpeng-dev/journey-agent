...
export type PublicTask = { id: string; goal: string; status: string; objective_names: string[]; plan: { version: number; strategy_summary: string; updated: boolean; steps: PublicPlanStep[] } | null; explanation: string | null };
