...
export type PublicTimelineEvent = { id: string; kind: TimelineEventKind; planning_cycle_id?: string | null; title: string; detail: string | null; actor_name: string | null; result_summary: string | null; success: boolean | null; knowledge_changes: KnowledgeChange[]; occurred_at: string | null; duration_ms?: number | null; location?: ActionLocation | null };
