...
const enums: Record<string, string[]> = {
  ...
  capabilities: ["PLAN", "EXECUTE_ACTION", "INSPECT_STATE", "LOGISTICS"], allowed_actor_capabilities: ["PLAN", "EXECUTE_ACTION", "INSPECT_STATE", "LOGISTICS"],
  execution_mode: ["IMMEDIATE", "ASYNC"], phase: ["PREFLIGHT", "RESOLVE"],
  behavior: ["RULE", "TRAVEL", "INSPECT", "TRANSPORT_RESOURCE"],
  locality: ["NONE", "LOCAL_TARGET", "FACILITY_REGION", "TRANSPORT_ENDPOINT"],
  resource_scope_kind: ["EXPLICIT", "ACTOR_CURRENT_REGION", "CURRENT_TARGET_REGION"],
